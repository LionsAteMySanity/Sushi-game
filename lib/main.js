...
class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        this.nextPage2.on('pointerdown', () => {
            ...
            this.add.text(100,800, "If you still aren't quite sure what to do, we have provided an example gameplay video that you can watch!", {//fontFamily: 'Times New Roman',
            fontSize: 45,
            color: '#ffffff',
            align: "left",
        ...
        this.tutorialButton = this.add.text(400,300, "Play tutorial video").setTint(0xffffff).setFontSize(70).setInteractive().setAlpha(0);
        ...
        this.startButton = this.add.text(1600,900, "Play!").setTint(0xaa00aa).setFontSize(80).setInteractive().setAlpha(0);
...
const game = new Phaser.Game({
    ...
    scene: [Start, intro, Menu, Tutorial, Shop, Earnings, Credits],
    title: "Sushi Game"
});
