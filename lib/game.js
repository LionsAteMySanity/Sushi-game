class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        const text = this.add.text(400, 300, 'Hello, Phaser 3!', { fontSize: '32px', fill: '#fff' });
        text.setOrigin(0.5);

        this.startButton = this.add.text(200,600, "Play!").setTint(0xaa00aa).setFontSize(75).setInteractive();
