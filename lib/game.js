...
class Earnings extends Phaser.Scene {
    ...
    create() {
        ...
        this.website = this.add.image(x, y, 'website')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);
        ...
        this.webBlishButton = this.add.image(x + 300, y + 370, 'webButton')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);

        this.webBlish = this.add.image(x + 300, y + 390, 'webBlish')
        .setOrigin(0,0)
        .setScale(1)
        ...
        this.webBlishText = this.add.image(x + 400, y + 540, 'webBlishText')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);
        ...
        this.webKukoiButton = this.add.image(x + 30, y + 370, 'webButton')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);

        this.webKukoi = this.add.image(x + 80, y + 400, 'webKukoi')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1).setInteractive()
        .on('pointerdown', () => {
        ...
        this.webKukoiText = this.add.image(x + 120, y + 530, 'webKukoiText')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);
        ...
        this.webTazoiButton = this.add.image(x + 30, y + 600, 'webButton')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);

        this.webTazoi = this.add.image(x + 25, y + 630, 'webTazoi')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1)
        .setInteractive()
        ...
        this.webTazoiText = this.add.image(x + 120, y + 775, 'webTazoiText')
        .setOrigin(0,0)
        .setScale(1)
        .setAlpha(1);
